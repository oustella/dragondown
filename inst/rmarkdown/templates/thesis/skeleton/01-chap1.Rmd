...
The last two options make the table a little easier-to-read. The `repeat_header` option in the `kable_styling` command is required to properly conform to Drexel's table requirements. This option allows for the table caption to be repeated on each page as the Thesis Manual dictates. 

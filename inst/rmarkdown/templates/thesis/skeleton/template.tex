...
% OSL added the array package to avoid pandoc error 'undefined control sequence' with manually written tables (example in chapter 3)
...
% Added by OSL to avoid Pandoc version 2.11+ error related to CSLReferences
$if(csl-refs)$

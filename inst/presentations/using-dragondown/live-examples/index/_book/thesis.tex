...
Virgin America & 366\\*
\end{longtable}
The last two options make the table a little easier-to-read. The \texttt{repeat\_header} option in the \texttt{kable\_styling} command is required to properly conform to Drexel's table requirements. This option allows for the table caption to be repeated on each page as the Thesis Manual dictates.
